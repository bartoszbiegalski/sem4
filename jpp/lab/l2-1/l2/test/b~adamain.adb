pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~adamain.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~adamain.adb");
...
package body ada_main is
   ...
   E006 : Short_Integer; pragma Import (Ada, E006, "interfaces__c_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_symtbl_main");
