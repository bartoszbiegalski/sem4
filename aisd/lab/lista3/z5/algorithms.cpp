...
void QuickSort(int *A, int p, int q, int &swap_number, int &comp_number) {
    if (p < q) {
        //print(A, p, q);



        int pivot = RandomizedSelect(A, p, q, , swap_number, comp_number);
        QuickSort(A, p, pivot - 1, swap_number, comp_number);
        QuickSort(A, pivot + 1, q, swap_number, comp_number);
